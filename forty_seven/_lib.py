...
q_schemas = {
    "A": nauert.MeasurewiseQSchema(
        search_tree=search_trees["A"],
        tempo=metronome_marks["72"],
        time_signature=(7, 8),
    ),
    "B": nauert.MeasurewiseQSchema(
        search_tree=search_trees["B"],
        tempo=metronome_marks["72"],
        time_signature=(7, 8),
        use_full_measure=True,
    ),
    "C": nauert.MeasurewiseQSchema(
        search_tree=search_trees["C"],
        tempo=metronome_marks["72"],
        time_signature=(7, 8),
        use_full_measure=True,
    ),
    "D": nauert.MeasurewiseQSchema(
